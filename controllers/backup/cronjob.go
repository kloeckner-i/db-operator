...
func GCSBackupCron(conf *config.Config, dbcr *kindav1beta11.Database, ownership []metav1.OwnerReference) (*batchv1beta1.CronJob, error) {
...
func buildCronJobSpec(conf *config.Config, dbcr *kindav1beta11.Database) (batchv1beta1.CronJobSpec, error) {
...
func buildJobTemplate(conf *config.Config, dbcr *kindav1beta11.Database) (batchv1beta1.JobTemplateSpec, error) {
