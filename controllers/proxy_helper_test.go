...
func makeGsqlInstance() kindav1beta11.DbInstance {
	info := make(map[string]string)
	info["DB_CONN"] = "test-conn"
	info["DB_PORT"] = "1234"
	dbInstance := kindav1beta11.DbInstance{
		Spec: kindav1beta11.DbInstanceSpec{
			DbInstanceSource: kindav1beta11.DbInstanceSource{
				Google: &kindav1beta11.GoogleInstance{},
			},
		},
		Status: kindav1beta11.DbInstanceStatus{
			Info: info,
		},
	}
	return dbInstance
...
func makeGenericInstance() kindav1beta11.DbInstance {
	info := make(map[string]string)
	info["DB_CONN"] = "test-conn"
	info["DB_PORT"] = "1234"
	dbInstance := kindav1beta11.DbInstance{
