...
func determineProxyTypeForDB(conf *config.Config, dbcr *kindav1beta11.Database) (proxy.Proxy, error) {
...
func determineProxyTypeForInstance(conf *config.Config, dbin *kindav1beta11.DbInstance) (proxy.Proxy, error) {
