...
func (r *DbInstanceReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&kindav1beta11.DbInstance{}).
		Complete(r)
}

func (r *DbInstanceReconciler) create(ctx context.Context, dbin *kindav1beta11.DbInstance) error {
...
func (r *DbInstanceReconciler) broadcast(ctx context.Context, dbin *kindav1beta11.DbInstance) error {
	dbList := &kindav1beta11.DatabaseList{}
...
func (r *DbInstanceReconciler) createProxy(ctx context.Context, dbin *kindav1beta11.DbInstance, ownership []metav1.OwnerReference) error {
