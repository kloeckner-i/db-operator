...
func (r *DatabaseReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	return ctrl.NewControllerManagedBy(mgr).
		For(&kindav1beta11.Database{}).
		WithEventFilter(eventFilter).
		Watches(&source.Kind{Type: &corev1.Secret{}}, &secretEventHandler{r.Client}).
		Complete(r)
}

func (r *DatabaseReconciler) initialize(ctx context.Context, dbcr *kindav1beta11.Database) error {
	dbcr.Status = kindav1beta11.DatabaseStatus{}
	dbcr.Status.Status = false

	if dbcr.Spec.Instance != "" {
		instance := &kindav1beta11.DbInstance{}
...
func (r *DatabaseReconciler) createDatabase(ctx context.Context, dbcr *kindav1beta11.Database, ownership []metav1.OwnerReference) error {
	databaseSecret, err := r.getDatabaseSecret(ctx, dbcr)
	if err != nil {
		if k8serrors.IsNotFound(err) {
...
func (r *DatabaseReconciler) deleteDatabase(ctx context.Context, dbcr *kindav1beta11.Database) error {
...
func (r *DatabaseReconciler) createInstanceAccessSecret(ctx context.Context, dbcr *kindav1beta11.Database, ownership []metav1.OwnerReference) error {
...
func (r *DatabaseReconciler) createProxy(ctx context.Context, dbcr *kindav1beta11.Database, ownership []metav1.OwnerReference) error {
...
func (r *DatabaseReconciler) createTemplatedSecrets(ctx context.Context, dbcr *kindav1beta11.Database, ownership []metav1.OwnerReference) error {
...
func (r *DatabaseReconciler) createInfoConfigMap(ctx context.Context, dbcr *kindav1beta11.Database, ownership []metav1.OwnerReference) error {
	instance, err := dbcr.GetInstanceRef()
	if err != nil {
		return err
	}
...
func (r *DatabaseReconciler) createBackupJob(ctx context.Context, dbcr *kindav1beta11.Database, ownership []metav1.OwnerReference) error {
...
func (r *DatabaseReconciler) getDatabaseSecret(ctx context.Context, dbcr *kindav1beta11.Database) (*corev1.Secret, error) {
	secret := &corev1.Secret{}
	key := types.NamespacedName{
...
func (r *DatabaseReconciler) annotateDatabaseSecret(ctx context.Context, dbcr *kindav1beta11.Database, secret *corev1.Secret) error {
...
func (r *DatabaseReconciler) getAdminSecret(ctx context.Context, dbcr *kindav1beta11.Database) (*corev1.Secret, error) {
	instance, err := dbcr.GetInstanceRef()
	if err != nil {
...
func (r *DatabaseReconciler) manageError(ctx context.Context, dbcr *kindav1beta11.Database, issue error, requeue bool) (reconcile.Result, error) {
	dbcr.Status.Status = false
