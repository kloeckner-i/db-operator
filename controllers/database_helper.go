...
func determinDatabaseType(dbcr *kindav1beta11.Database, dbCred database.Credentials) (database.Database, error) {
...
func parseTemplatedSecretsData(dbcr *kindav1beta11.Database, data map[string][]byte) (database.Credentials, error) {
...
func parseDatabaseSecretData(dbcr *kindav1beta11.Database, data map[string][]byte) (database.Credentials, error) {
...
func generateDatabaseSecretData(dbcr *kindav1beta11.Database) (map[string][]byte, error) {
	const (
...
func generateTemplatedSecrets(dbcr *kindav1beta11.Database, databaseCred database.Credentials) (secrets map[string][]byte, err error) {
...
func appendTemplatedSecretData(dbcr *kindav1beta11.Database, secretData map[string][]byte, newSecretFields map[string][]byte, ownership []metav1.OwnerReference) map[string][]byte {
...
func removeObsoleteSecret(dbcr *kindav1beta11.Database, secretData map[string][]byte, newSecretFields map[string][]byte, ownership []metav1.OwnerReference) map[string][]byte {
	blockedTempatedKeys := getBlockedTempatedKeys()
