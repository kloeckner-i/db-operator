...
func isDBChanged(dbcr *kindav1beta11.Database, databaseSecret *corev1.Secret) bool {
...
func addDBChecksum(dbcr *kindav1beta11.Database, databaseSecret *corev1.Secret) {
	annotations := dbcr.ObjectMeta.GetAnnotations()
...
func isDBInstanceSpecChanged(ctx context.Context, dbin *kindav1beta11.DbInstance) bool {
...
func addDBInstanceChecksumStatus(ctx context.Context, dbin *kindav1beta11.DbInstance) {
	checksums := dbin.Status.Checksums
	if len(checksums) == 0 {
